...
function Player(props: {
  ...
  const { players, key, setPlayers } = props;
  ...
  const handleDelete = () => {
    // Delete player with the given key
    setPlayers(players.filter((_, i) => i !== key));
  }
...
export default function RegisterPlayers(props: {
  ...
  function addPlayer() {
    ...
    if (!players.includes(playerToBeAdded) && playerToBeAdded !== "") {
      // Add player
