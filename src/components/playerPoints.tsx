...
export default function PlayerPoints(props: { playersState: Player[], highlightedPlayer: string, setHighlightedPlayer: (player: string) => void }) {
  const { playersState, highlightedPlayer, setHighlightedPlayer } = props;

  return (
    <div>
      <h4 style={{ display: "flex", justifyContent: "center" }}>Who won the point?</h4>
